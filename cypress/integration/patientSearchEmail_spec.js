describe('As a doctor , I want to be able to search a patient by their email', () => {
     it('A doctor can access the patients profile through the search bar by typing their patients email', () => {
            ...
            cy.findByRole('textbox', { name: /this\.example@email\.com/i }).type('mlaura@hotmail.com')// select email field and enter email : mlaura@hotmail.com
            cy.findByTestId('sign-up-password').type('doctorpass2')// select password field and enter password :  doctorpass2
